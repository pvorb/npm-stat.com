...
public class TimeBucket1 extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = -1400030421;
     ...
     */
    public TimeBucket1 setBucketWidth(Field<Object> field) {
     ...
     */
    public TimeBucket1 setTs(Field<Timestamp> field) {
        setField(TS, field);
        return this;
    }
}
