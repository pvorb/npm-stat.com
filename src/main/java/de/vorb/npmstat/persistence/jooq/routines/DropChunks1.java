...
public class DropChunks1 extends AbstractRoutine<java.lang.Void> {

    private static final long serialVersionUID = -1414804105;

    /**
     * @deprecated Unknown data type. Please define an explicit {@link org.jooq.Binding} to specify how this type should be handled. Deprecation can be turned off using <deprecationOnUnknownTypes/> in your code generator configuration.
     */
    @java.lang.Deprecated
    public static final Parameter<Object> OLDER_THAN = createParameter("older_than", org.jooq.impl.DefaultDataType.getDefaultDataType("anyelement"), false, false);
