...
public class TimeBucket4 extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = -1341503555;
     ...
     */
    public static final Parameter<Timestamp> TS = createParameter("ts", org.jooq.impl.SQLDataType.TIMESTAMP, false, false);
     ...
     */
    public TimeBucket4() {
        super("time_bucket", Public.PUBLIC, org.jooq.impl.SQLDataType.TIMESTAMP);
     ...
     */
    public TimeBucket4 setBucketWidth(Field<Object> field) {
     ...
     */
    public TimeBucket4 setTs(Field<Timestamp> field) {
        setField(TS, field);
        return this;
    }
     ...
     */
    public TimeBucket4 setOffset(Field<Object> field) {
