...
public class DownloadCount extends TableImpl<DownloadCountRecord> {
    ...
    private static final long serialVersionUID = 957741581;
    ...
    public <O extends Record> DownloadCount(Table<O> child, ForeignKey<O, DownloadCountRecord> key) {
        super(child, key, DOWNLOAD_COUNT);
    }
