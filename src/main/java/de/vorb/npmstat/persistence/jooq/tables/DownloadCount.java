...
public class DownloadCount extends TableImpl<DownloadCountRecord> {
    ...
    private static final long serialVersionUID = -1812679129;
     ...
     */
    public final TableField<DownloadCountRecord, String> PACKAGE_NAME = createField("package_name", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");
